...
public class OsUserCntAppWithBloomFilter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<AccessOrigin> cleanStream = environment.socketTextStream("localhost", 9527)
        ...
        cleanStream.keyBy(x -> x.deviceType)
                .process(new KeyedProcessFunction<String, AccessOrigin, AccessOrigin>() {
                    ...
                    @Override
                    public void processElement(AccessOrigin value, Context ctx, Collector<AccessOrigin> out) throws Exception {
