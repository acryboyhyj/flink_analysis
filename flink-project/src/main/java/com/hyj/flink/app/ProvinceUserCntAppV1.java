...
import com.hyj.flink.udf.GaodeLocationMapFunction;
...
public class ProvinceUserCntAppV1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple3<String, Integer, Integer>> result = cleanStream.map(new MapFunction<AccessOrigin, Tuple3<String, Integer, Integer>>() {
            @Override
            public Tuple3<String, Integer, Integer> map(AccessOrigin value) throws Exception {
